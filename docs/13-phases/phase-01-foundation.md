...
Lock product vision, requirements, folder docs
...
- Documentation and (post-approval) implementation artifacts for: Foundation
- Related sprints: Sprint 01, Sprint 02
