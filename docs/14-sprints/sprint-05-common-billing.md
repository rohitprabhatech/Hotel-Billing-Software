# Sprint 05 – Common Billing

## Objective

Billing engine & POS flows
...
- TEST-BILL-001: Happy path for sprint objective
- TEST-BILL-002: Negative / unauthorized access
- TEST-BILL-003: Regression on prior phases
