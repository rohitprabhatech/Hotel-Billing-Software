# Phase 04 – Common Billing

## 1. Phase objective

Billing, products, inventory, CRM core
...
- Documentation and (post-approval) implementation artifacts for: Common Billing
- Related sprints: Sprint 05, Sprint 06
