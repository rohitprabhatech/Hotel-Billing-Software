...
|--------|-------|---------|
| TourPackage | BUSINESS-SPECIFIC | Sellable package/service |
| Booking | BUSINESS-SPECIFIC | Customer booking |
| Itinerary | BUSINESS-SPECIFIC | Trip plan |
| TravelDocument | BUSINESS-SPECIFIC | Passport etc. refs |
| BookingComponent | BUSINESS-SPECIFIC | Hotel/vehicle/ticket lines |
| Agent | BUSINESS-SPECIFIC | Travel agent |
| AgentCommission | BUSINESS-SPECIFIC | Commission entries |
