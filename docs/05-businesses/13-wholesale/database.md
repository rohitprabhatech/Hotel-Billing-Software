...
| StockTransfer | BUSINESS-SPECIFIC | Transfer |
| CustomerPriceList | BUSINESS-SPECIFIC | Customer-wise prices |
| PurchaseOrder | BUSINESS-SPECIFIC | PO |
| SalesOrder | BUSINESS-SPECIFIC | SO |
| Quotation | BUSINESS-SPECIFIC | Quote |
