"""Sales orders convertible to bills (BIZ-52)."""
...
ALLOWED_SALES_ORDER_STATUSES = frozenset(
...
class SalesOrderNumberCounter(db.Model):
...
class SalesOrder(db.Model, TimestampMixin):
    ...
    items = relationship("SalesOrderItem", back_populates="sales_order", lazy="selectin")
