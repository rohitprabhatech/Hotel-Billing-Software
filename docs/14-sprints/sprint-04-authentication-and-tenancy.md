# Sprint 04 – Authentication and Tenancy
...
- TEST-AUTH-001: Happy path for sprint objective
- TEST-AUTH-002: Negative / unauthorized access
- TEST-AUTH-003: Regression on prior phases
