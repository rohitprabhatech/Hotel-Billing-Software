# Sprint 10 – AI and Notifications
...
- TEST-AI-001: Happy path for sprint objective
- TEST-AI-002: Negative / unauthorized access
- TEST-AI-003: Regression on prior phases
