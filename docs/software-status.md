...
| Date | Note |
|------|------|
| 2026-08-29 | **Clothing billing sign-off** (`rs/testing/cloth-29` → `dev`): optional manual **Customer name** on Clothing POS (`customer_name` on bill API). **No new migration** — Alembic head `20260827_cafe_coupons`. |
