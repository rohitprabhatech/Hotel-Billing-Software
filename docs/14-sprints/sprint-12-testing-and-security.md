# Sprint 12 – Testing and Security
...
- TEST-SEC-001: Happy path for sprint objective
- TEST-SEC-002: Negative / unauthorized access
- TEST-SEC-003: Regression on prior phases
