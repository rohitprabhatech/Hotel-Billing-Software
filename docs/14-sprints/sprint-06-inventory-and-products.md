# Sprint 06 – Inventory and Products

## Objective

Products, stock, CRM/procurement
...
- TEST-INV-001: Happy path for sprint objective
- TEST-INV-002: Negative / unauthorized access
- TEST-INV-003: Regression on prior phases
