...
export const PATHS = {
  ...
  ownerRestaurantBilling: '/owner/restaurant-billing',
  ownerKitchen: '/owner/kitchen',
  ownerCafe: '/owner/cafe',
  ownerAddons: '/owner/addons',
  ownerCombos: '/owner/combos',
  ownerCoupons: '/owner/coupons',
  ...
  ownerIngredients: '/owner/ingredients',
  ...
  billingIngredients: '/billing/ingredients',
  ...
  billingAddons: '/billing/addons',
  billingCombos: '/billing/combos',
  billingCoupons: '/billing/coupons',
  billingGrocery: '/billing/grocery',
  billingPriceLists: '/billing/price-lists',
  billingSalesOrders: '/billing/sales-orders',
  billingPurchaseOrders: '/billing/purchase-orders',
  billingQuotations: '/billing/quotations',
  billingChallans: '/billing/challans',
  billingWarehouses: '/billing/warehouses',
  billingTourPackages: '/billing/tour-packages',
  billingTravelBookings: '/billing/travel-bookings',
  billingTravelAgents: '/billing/travel-agents',
