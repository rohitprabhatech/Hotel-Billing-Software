# Sprint 02 – System Architecture

## Objective

Lock architecture docs
...
- TEST-ARCH-001: Happy path for sprint objective
- TEST-ARCH-002: Negative / unauthorized access
- TEST-ARCH-003: Regression on prior phases
