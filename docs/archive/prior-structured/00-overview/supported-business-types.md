...
| 7 | [07-bakery-sweet-shops](../05-businesses/07-bakery-sweet-shops/) | Bakery / Sweet Shops | `bakery_sweets` |
...
| 12 | [12-book-stores](../05-businesses/12-book-stores/) | Book Stores | `bookstore` |
...
**Removed from scope:** Medical Store.

Current live codes (`restaurant`, `hotel`, `kirana_store`, …) will map to this catalog in a future approved sprint — not executed in documentation phase.
