# Backup and Recovery — Prabha Billing SaaS / Business Billing

**Product:** Prabha Billing SaaS (current UI: Business Billing) · Prabha Technology Pvt. Ltd.  
**Hosted database name (current production target):** `u583892242_HotelBillingDB`  
**V2 note:** Documentation phase does **not** authorize new schema. Future industry tables require approved sprint + backup + inspect first.
